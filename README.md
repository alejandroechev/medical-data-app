...
> **v0.5.5** — PWA (web) · Native Desktop (Tauri/Windows) · Native Android (Tauri)
...
- Tratamientos UX consistent with Eventos: click to view detail, swipe for Detener/Reiniciar + Archivar
